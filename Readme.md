...
It's easy to implement your own code generator as well.
...
namespace Wrapper
{
    ...
    public static class d3d10
    {
        ...
        static d3d10()
        {
            ...
            dRevertToOldImplementation = GetDelegate<tRevertToOldImplementation>(RealHandler, "RevertToOldImplementation", false);
        ...
        [DllExport(CallingConvention = CallingConvention.StdCall)]
        public static uint RevertToOldImplementation()
        {
            return dRevertToOldImplementation();
        }
